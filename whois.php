...
{
  $domain="mobi-host.com";
}
$domain=str_replace("http://","",$domain);
$domain=str_replace("https://","",$domain);
$domain=str_replace("ftps://","",$domain);
$domain=str_replace("ftp://","",$domain);
$whois=new Whois($domain);
$whois->success="ok";
$whois->query=$domain;
$check=$whois->isAvailable();
$whois->free=$check?"Домен свободен":"Домен занят";
$whois->isAvailable=$check;
$whois->info=explode("\n",$whois->info());
$whois->tlds=$whois->getTLDs();
